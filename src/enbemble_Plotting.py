...
def Generate_Three_Pane_TOE_Plots():
    ...
    for model in models:
        for temperature_Type in t_Data_Types:
             ...
             new_im.save("Ensemble Plots"+ "\\" + "Ensemble TOE Plot with " + model + " based on " + temperature_Type+".png")
        for precipitation_Type in p_Data_Types:
             ...
             new_im.save("Ensemble Plots"+ "\\" + "Ensemble TOE Plot with "+ model + " based on " + precipitation_Type+".png")
