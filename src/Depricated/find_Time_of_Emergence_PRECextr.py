# -*- coding: utf-8 -*-
"""
Created on Mon Sep 28 20:40:53 2020
...
def generateToEData(file, Precipitation_Type):
...
#execute
generateToEData("access1.0_1970-2099_PRECextr.nc", "95") #the second input can be the folllowing strings "'x'" or "'95'" for now
